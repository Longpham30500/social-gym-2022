...
const StatusModal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (images.length === 0)
    return dispatch({
      type: GLOBALTYPES.ALERT, payload: { err: "Please add your photo."}
    })
...
<div className="show_images">
            ...
            <div className="input_images">
              {
                stream
                ? <box-icon type='solid' name='camera' onClick={handleCapture} />
                : <>
                    <box-icon type='solid' name='camera' onClick={handleStream} />
